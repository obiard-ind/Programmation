...
Vous utiliserez une boucle `while` qui continuera de demander à l'utilisateur le prénom et la note de l'élève; jusqu'à ce que l'utilisateur appuie sur le touche 'N' ou 'n' (pour signifier : 'non, je n'ai plus de notes à encoder).
...
Poursuivez en affichant, vos emoji sous forme d'un tableau; à raison d'un emoji par ligne.
Ce tableau aura pour en-tête de colonnes les noms suivants : 'Code hex' et 'emoji'
